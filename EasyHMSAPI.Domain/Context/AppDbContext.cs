...
namespace EasyHMSAPI.Domain.Context
{
    ...
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<PatientNurseAssignment> PatientNurseAssignment { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           modelBuilder.Entity<Doctor>()
            ...
            modelBuilder.Entity<PatientNurseAssignment>(entity =>
            {
                entity.ToTable("PatientNurseAssignment");
                entity.HasKey(a => a.PatientNurseAssignmentId);
                entity.Property(a => a.ShiftDate).HasColumnType("date");
                entity.Property(a => a.AssignedAt).HasColumnType("datetime2(3)");
                entity.Property(a => a.UnassignedAt).HasColumnType("datetime2(3)");
                entity.Property(a => a.CreatedAt).HasColumnType("datetime2(3)");
            ...
            modelBuilder.Entity<AbdmProfileShare>(entity =>
            {
                entity.ToTable("AbdmProfileShare");
            ...
            {
                entity.ToTable("AbdmFacility");
                entity.HasKey(f => f.HospitalId);
