...
{
    [TestFixture]
    public class SearchMedicinesHandlerTests
    {
         private AppDbContext _context = null!;
        private Mock<IDoctorValidationHelper> _doctorValidationHelperMock = null!;
        private SearchMedicinesHandler _handler = null!;
        ...
        public void SetUp()
        {
            ...
            _handler = new SearchMedicinesHandler(_context, _doctorValidationHelperMock.Object);
        }
        ...
        public async Task Handle_ReturnsMedicines()
        {
            ...
            var request = new SearchMedicinesRequestModel
            {
                HospitalId = hospitalId,
                DoctorId = doctor.DoctorID,
                SearchText = "Asp"
