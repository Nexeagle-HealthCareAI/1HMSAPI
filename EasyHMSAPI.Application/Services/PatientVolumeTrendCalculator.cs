namespace EasyHMSAPI.Application.Services
{
    ...
    public record PatientVolumeTrendSummary(
        ...
        decimal PredictedTomorrowUniquePatients,
    ...
    public static class PatientVolumeTrendCalculator
    {
            ...
            Dictionary<string, List<(DateTime Date, int Count)>> appointmentsBySpecialty)
        {
            ...
            return new PatientVolumeTrendSummary(
                ...
                PredictedTomorrowAppointments: projected[0].TotalAppointments,
                PredictedTomorrowUniquePatients: projected[0].UniquePatients,
                PredictedNext7DayAppointments: projected.Take(7).Sum(p => p.TotalAppointments),
                PredictedNext7DayUniquePatients: projected.Take(7).Sum(p => p.UniquePatients),
