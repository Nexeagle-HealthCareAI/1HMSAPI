namespace EasyHMSAPI.Application.Services
{
    ...
    public record TrendSummary(
        ...
        decimal PredictedTomorrowRevenue,
        decimal PredictedTomorrowExpense,
        decimal PredictedNext7DayRevenue,
        decimal PredictedNext7DayExpense,
    ...
    public static class BillingTrendCalculator
    {
            ...
            Dictionary<string, List<(DateTime Date, decimal Amount)>> revenueByCategory)
        {
            ...
            return new TrendSummary(
                ...
                PredictedTomorrowRevenue: Math.Round(projectedDailyRev, 2),
                PredictedTomorrowExpense: Math.Round(projectedDailyExp, 2),
                PredictedNext7DayRevenue: Math.Round(projectedDailyRev * 7, 2),
                PredictedNext7DayExpense: Math.Round(projectedDailyExp * 7, 2),
