...
builder.Services.AddHttpClient<IPatientVolumeInsightService, GroqPatientVolumeInsightService>();
builder.Services.AddHttpClient<IPatientChurnInsightService, GroqPatientChurnInsightService>();
